...
process.env.FACEBOOK_CALLBACK_URL="https://ozfam.herokuapp.com/user/auth/facebook/callback";
...
process.env.GOOGLE_CALLBACK_URL="https://ozfam.herokuapp.com/user/auth/google/callback";
process.env.ORIGIN="https://ozfam.herokuapp.com"
...
app.use(cors())
// This configuration is needed if client is hosted on diffferent server
// const io = require('socket.io')(http, {
//   cors: {
