		...
		if(!user){
			...
			return (
				<div className='flex flex-col items-center w-full'>
					...
					<p className="w-full text-center text-3xl font-mono mt-2 break-words">{user.name}</p>
					<p className="w-full text-center text-xl font-sans text-gray-500 break-words">@{user.username}</p>
